...
exports.verifyByCnpj = async function (cnpj, id){
    ...
    try {
        if (!id && response.length == 0) {
            return new ResponseDTO('Success', 200, '✔️Company not found');
        }
...
exports.post = async function(company) {
    try{
        ...
        if(validation.type == 'Success'){
            ...
            return new ResponseDTO('Success', 201, '✔️Successfully registered company.', data);
        } else{
            return new ResponseDTO('Error', 409, '❌CNPJ is in use') 
        }
...
exports.put = async function(id, company) {
    try{
        ...
        if(validation){
            ...
            return new ResponseDTO('Success', 200, '✔️Company updated successfully.', await adminData.getCompany(id))
        }
        else{
...
exports.delete = async function(id) {
    try{
        ...
        if(company){
          ...
          return new ResponseDTO('Success', 200, '✔️Successfully deleted company.');
        }
        else{
